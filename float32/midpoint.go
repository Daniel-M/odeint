...
func NewMidpoint(stepSize float32, system System) (r *Midpoint) {
	if stepSize <= 0 {
...
func (midpoint *Midpoint) SetStep(step float32) error {
	midpoint.stepSize = step
	return nil
}

// SetState sets the state for the Midpoint stepper.
func (midpoint *Midpoint) SetState(state []float32) error {
	midpoint.system.stateVector = state
	return nil
}

// Set sets the step size and System for the Midpoint stepper.
func (midpoint *Midpoint) Set(stepSize float32, system System) error {
	if stepSize <= 0 {
...
func (midpoint *Midpoint) StepSize() float32 {
	return midpoint.stepSize
}

// State returns the state of the Midpoint stepper.
func (midpoint *Midpoint) State() []float32 {
...
func (midpoint *Midpoint) Step() ([]float32, error) {

	stateK1 := make([]float32, len(midpoint.system.stateVector))
