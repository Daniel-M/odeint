...
func TestNewRk4(t *testing.T) {
	...
	sys := NewSystem(vector, params, func(x []float32, parameters []float32) []float32 {
...
func TestRk4Step(t *testing.T) {
	...
	stateK1 := make([]float32, len(vector))
	stateK2 := make([]float32, len(vector))
	stateK3 := make([]float32, len(vector))
	stateK4 := make([]float32, len(vector))

	BufferK1 := make([]float32, len(vector))
	BufferK2 := make([]float32, len(vector))
	BufferK3 := make([]float32, len(vector))
