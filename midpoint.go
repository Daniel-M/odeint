...
func NewMidpoint(stepSize Float, system System) (r *Midpoint) {
	if stepSize <= 0 {
...
func (midpoint *Midpoint) StepSize() Float {
	return midpoint.stepSize
}

// State returns the state of the Midpoint stepper.
func (midpoint *Midpoint) State() []Float {
...
func (midpoint *Midpoint) Step() ([]Float, error) {

	stateK1 := make([]Float, len(midpoint.system.stateVector))
